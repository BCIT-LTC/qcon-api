...
fragment QUESTION_HEADER_WITH_NEWLINE_ADDED: (NEWLINE_ADDED? QUESTION_HEADER_PARAMETER)+;   
fragment QUESTION_HEADER_PART: QUESTION_HEADER_WITH_NEWLINE_ADDED NEWLINE*;
fragment QUESTION_HEADER: QUESTION_HEADER_PART+;
fragment QUESTION_START: NEWLINE_ADDED? START_OF_QUESTION_NOT_ONE | NEWLINE_ADDED? START_OF_QUESTION_ONE; 

QUESTION: QUESTION_HEADER? NEWLINE* QUESTION_START;
