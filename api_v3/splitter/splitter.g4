...
first_question: question_header? content;

questions:  (NEWLINE_ADDED| NEWLINE_ADDED? question_header)? START_OF_QUESTION content;
...
START_OF_QUESTION: NEWLINE* START_OL? NEWLINE* NUMLIST_EXCLUDE_1_PREFIX;
