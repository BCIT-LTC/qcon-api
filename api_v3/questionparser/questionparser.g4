...
trailing_content: (ALL_CHARACTER|END_OL)*;
...
fragment STAR_AFTER_DOT: NEWLINE WHITESPACE* LETTER WHITESPACE* DELIMITER WHITESPACE* ANSWER_MARKER WHITESPACE*;
fragment STAR_BEFORE_DOT: NEWLINE WHITESPACE* LETTER WHITESPACE* ANSWER_MARKER WHITESPACE* DELIMITER WHITESPACE*;
fragment STAR_BEFORE_LETTER: NEWLINE WHITESPACE* ANSWER_MARKER WHITESPACE* LETTER WHITESPACE* DELIMITER WHITESPACE*;

START_OL: NEWLINE '<!-- START OF OL -->' NEWLINE;
END_OL: NEWLINE '<!-- END OF OL -->' NEWLINE;

NUMLIST_PREFIX: NEWLINE WHITESPACE* NUMBER WHITESPACE* DELIMITER WHITESPACE*;
LETTERLIST_PREFIX: NEWLINE WHITESPACE* LETTER WHITESPACE* DELIMITER WHITESPACE*;

FIB_START: OPEN_BRACKET WHITESPACE*; 
FIB_END: WHITESPACE* CLOSE_BRACKET;


CORRECT_ANSWER: (STAR_AFTER_DOT|STAR_BEFORE_DOT|STAR_BEFORE_LETTER);
